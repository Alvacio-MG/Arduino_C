...
const int pinA = 13; // Pin conectado a la fase A del motor paso a paso
const int pinB = 12; // Pin conectado a la fase B del motor paso a paso
const int pinC = 14; // Pin conectado a la fase C del motor paso a paso
const int pinD = 27; // Pin conectado a la fase D del motor paso a paso
const int pinPot = 26; //Pin conectado al potenciometro para regular la velocidad de cambio de estado
const int pinBot = 25;
unsigned long rpm = 0;
int potStat = 0;
int botStat = false;
...
const int tiempoPaso = 10; // Tiempo de espera entre pasos en milisegundos
...
// Establecer los estados de las salidas según el estado actual
  ...
  delay(potStat); //Establecer un tiempo entre el camabio de ciclos 
