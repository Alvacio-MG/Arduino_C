...
void gameOver(){ 
  ...
  }else
  {
    ...
    display.setTextColor(WHITE);
    display.setTextSize(2);
    display.println("No te");
    display.println("preocupes"); 
    display.println("sera la ");
    display.println("proxima");  
   }     if (posMen == 3){
    display.setCursor(45, 4);
    display.setTextColor(WHITE);
    display.setTextSize(2);
    display.println("quizas");
    display.println("algun"); 
    display.println("dia ");
    display.println("lo logres");  
   }     if (posMen == 4){
    display.setCursor(45, 4);
    display.setTextColor(WHITE);
    display.setTextSize(2);
    display.println("Realmente ");
    display.println("no es"); 
    display.println("facil");
    display.println("o si?");  
   }      
  }
 delay(200);
 display.display();
